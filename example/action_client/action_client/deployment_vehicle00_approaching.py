...
class TestActionClient(Node):
    ...
    def send_goal(self):
        ...
        deployment_request.shutdown = False
        ...
        app1.object_detection_fusion_app.requester_ids = ["vehicle00", "station00"]
        ego_data_vehicle00_topic = Topic()
        ego_data_vehicle00_topic.topic_name = "/vehicles/vehicle00/ego_data"
        ego_data_vehicle00_topic.source_node_id = "vehicle00"
        pointcloud_vehicle00_topic = Topic()
        pointcloud_vehicle00_topic.topic_name = "/vehicles/vehicle00/drivers/lidar/pointcloud"
        pointcloud_vehicle00_topic.source_node_id = "vehicle00"
        ...
        app1.object_detection_fusion_app.ego_data_topics = [ego_data_vehicle00_topic]
        app1.object_detection_fusion_app.pointcloud_topics = [pointcloud_vehicle00_topic, pointcloud_station00_topic]
        deployment_request.apps.append(app1)

        connection1 = Connection()
        connection1.id = "vehicle00/edge"
        connection1.requester_ids = ["vehicle00", "station00"]
        connection1.broker_node_id = "edge"
        connection1.source_node_id = "vehicle00"
        connection1.source_topics = ["/vehicles/vehicle00/drivers/lidar/pointcloud",
                                     "/vehicles/vehicle00/ego_data"]
        connection1.target_node_id = "edge"
        connection1.target_topics = ["/vehicles/vehicle00/drivers/lidar/pointcloud",
                                     "/vehicles/vehicle00/ego_data"]
        ...
        connection2.requester_ids = ["vehicle00", "station00"]
